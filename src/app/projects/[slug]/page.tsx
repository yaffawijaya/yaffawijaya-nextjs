...
export default function ProjectDetailPage({ params }: { params: { slug: string } }) {
  ...
  // This check is crucial: it determines if the button should be rendered.
  ...
  return (
    <>
      <div className="max-w-7xl mx-auto py-24 md:py-32 px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
          <aside className="lg:col-span-4">
            <div className="lg:sticky lg:top-28 bg-white dark:bg-stone-800/50 border border-stone-200 dark:border-stone-700 rounded-lg p-6 shadow-sm">
              ...
              <ul className="space-y-4">
                ...
                {/* The button is only rendered if 'hasLinks' is true */}
                {hasLinks && (
                  <li className="flex flex-col pt-4 border-t border-stone-200 dark:border-stone-700">
                    <button
                      onClick={() => setModalOpen(true)}
                      className="w-full text-center px-5 py-2 bg-amber-500 text-stone-900 text-sm font-semibold rounded-full hover:bg-amber-400 transition-colors"
                    >
                      View Project Links
                    </button>
                  </li>
          ...
          <article className="lg:col-span-8 text-stone-700 dark:text-stone-300 space-y-8">
            ...
            <div className="space-y-4">
                <h2 className="text-2xl sm:text-3xl font-bold text-stone-900 dark:text-white border-b border-stone-200 dark:border-stone-700 pb-3">My Solution</h2>
            ...
            <div className="bg-amber-50 dark:bg-stone-800/50 border border-amber-200 dark:border-stone-700 rounded-lg p-6">
                ...
                <ul className="space-y-3 text-base sm:text-lg">
                  {/* Features are now mapped dynamically */}
      ...
      {/* The modal is rendered here but only shown when isModalOpen is true */}
      {hasLinks && (
        <ProjectLinksModal
          isOpen={isModalOpen}
